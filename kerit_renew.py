...
# —— 展开 Turnstile iframe，防止被父容器 overflow:hidden 裁剪 ——
...
def do_renew(sb, ip_info=None, email=None):
    ...
    # 不 reconnect，直接导航到 free_panel，保持已建立的浏览器上下文
        ...
        with SB(**sb_kwargs) as sb:
            ...
            if not login_ok:
                ...
                if not turnstile_ready:
                    print("⚠️ Turnstile token 未检测到，尝试使用 katabump 风格过盾...")
